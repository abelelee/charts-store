...
它还有许多其他功能，如图像和视频搜索。一些计划中的功能详见 即将推出的功能。
...
Perplexica 建立在 AI 和大型语言模型应易于所有人使用的理念之上。如果你发现了 bug 或有想法，请通过 GitHub Issues 与我们分享。有关如何为 Perplexica 做出贡献的更多信息，请阅读 CONTRIBUTING.md 文件。
