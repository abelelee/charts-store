...
[![CI](https://github.com/YOURLS/YOURLS/actions/workflows/ci.yml/badge.svg)](https://github.com/YOURLS/YOURLS/actions/workflows/ci.yml) [![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/YOURLS/YOURLS/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/YOURLS/YOURLS/?branch=master) ![PHP 版本支持](https://img.shields.io/packagist/php-v/yourls/yourls) [![Packagist](https://img.shields.io/packagist/v/yourls/yourls.svg)](https://packagist.org/packages/yourls/yourls) [![OpenCollective](https://opencollective.com/yourls/backers/badge.svg)](https://opencollective.com/yourls#contributors) 
[![OpenCollective](https://opencollective.com/yourls/sponsors/badge.svg)](#sponsors)

**YOURLS** 是一套 PHP 脚本，允许你在**你自己的**服务器上运行 <strong>Y</strong>our <strong>O</strong>wn <strong>URL</strong> <strong>S</strong>hortener（你自己的网址缩短服务）。你将完全掌控你的数据，提供详细的统计信息、分析功能、插件支持等。它是免费且开源的。

## 开始使用

请查看 [docs.yourls.org](https://docs.yourls.org) 上的完整文档。  
其中涵盖了从入门到精通的所有内容。

## 社区新闻、技巧与提示

* 阅读并订阅 [YOURLS 官方博客](http://blog.yourls.org)
* 查看用户社区制作的内容：插件、工具、指南等，请访问 [Awesome YOURLS](https://github.com/YOURLS/awesome-yourls)
* 在我们的 [社区讨论区](https://github.com/YOURLS/YOURLS/discussions) 中与其他用户交流并寻求帮助
* 跟踪项目开发进展：为本项目“加星”和“关注”，并查看 [提交记录](https://github.com/YOURLS/YOURLS/commits/master)

## 贡献

有功能建议？发现 Bug？

__在提交任何问题之前，请先搜索现有的 [问题](https://github.com/YOURLS/YOURLS/issues)（包括已关闭的问题），并阅读 [贡献指南](https://github.com/YOURLS/.github/blob/master/CONTRIBUTING.md)。__

## 支持者

你是否在使用并喜欢 YOURLS？[成为支持者](https://opencollective.com/yourls#backer)，为我们的开源项目提供支持。
...
你的公司正在使用 YOURLS 吗？请询问你的经理或市场团队，是否愿意赞助我们的项目。你们的公司 Logo 将会显示在这里。通过 [成为赞助商](https://opencollective.com/yourls) 来支持我们的开源开发工作。
